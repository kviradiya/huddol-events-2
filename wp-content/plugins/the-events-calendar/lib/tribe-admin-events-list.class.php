	...
	class TribeEventsAdminList {
		...
		public static function init() {
			if ( is_admin() && ! ( defined( 'DOING_AJAX' ) && DOING_AJAX ) ) {
				...
				add_filter(
					'manage_' . TribeEvents::POSTTYPE . '_posts_columns', array(
						__CLASS__,
						'column_headers'
					)
				);
				add_filter(
					'tribe_apm_headers_' . TribeEvents::POSTTYPE, array(
						__CLASS__,
				...
				add_action(
					'manage_edit-' . TribeEvents::POSTTYPE . '_sortable_columns', array(
						__CLASS__,
