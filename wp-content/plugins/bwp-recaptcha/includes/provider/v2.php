...
<?php endforeach; ?>
		...
		<!-- load this only on register page -->
         <?php if ( in_array( $_SERVER['PHP_SELF'], array( '/wp-login.php', '/wp-register.php' ) ) ) {
		echo '<script src="https://www.google.com/recaptcha/api.js?onload=bwpRecaptchaCallback&render=explicit" async defer></script>';
		}
		?>
