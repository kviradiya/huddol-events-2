...
if (!class_exists('foolic_update_checker_v1_6')) {

	class foolic_update_checker_v1_6 {
		...
		function foolic_update_checker_v1_6($plugin_file, $plugin_update_url, $plugin_slug, $license_key) {
