...
class G1_Theme {
    ...
    public function capture_site_id() {
        ...
        if ( ! empty( $desktop_src) ) {
            ...
            $out_desktop =
                '<img'. $size_desktop .' id="g1-logo" usemap="#Map" src="'. esc_url($desktop_src) .'" alt="'. esc_attr($name) .'" '. $data_desktop_str .' />
                <noscript><img src="'. esc_url($desktop_src) .'" alt="'. esc_attr($name) .'" /></noscript>';

            $out_mobile =
                '<img'. $size_mobile .' id="g1-mobile-logo" usemap="#Map" src="'. esc_url($data['data-g1-src-mobile']) .'" alt="'. esc_attr($name) .'" '. $data_mobile_str .' />';
