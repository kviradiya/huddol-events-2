               ...
               <?php while ( have_posts() ) : the_post(); ?>
                   ...
                   <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                       ...
                       <div class="entry-content">
                                   ...
                                   <div class="g1-links">
                                       <ul>
                                           ...
                                           <?php if(ICL_LANGUAGE_CODE == 'en'): ?>
                                               <?php wp_list_pages( 'title_li=&include=68,371,72,70,82,84,88,66,186' ); ?>
                                       <?php else: ?>
                                            <?php wp_list_pages( 'title_li=&include=4114,4120,4106,4116,4139,4110,4118,4136,4134' ); ?>
                           ...
                           <div class="g1-grid">
                               <div class="g1-column g1-one-third">
                                   <h3><?php _e( 'Latest Stories', 'tcn' ); ?></h3>
                                   <div class="g1-links">
                                       <ul>
