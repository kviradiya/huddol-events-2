...
<?php include('header.php'); ?>
			...
			<div style="text-align: left;padding: 20px 40px;"> 
				...
				<p>
					...
					- <a href="https://thecaregivernetwork.ca/wp-content/uploads/2018/01/adobeconnect-troubleshooting-guide-en.pdf" style="color:#25aae1;">Download our troubleshooting guide</a>
				</p>
			</div>
            ...
            <script type="text/javascript">
                var myCalendar = createCalendar({
                  ...
                  data: {
                    ...
                    // Event start date
                    start: new Date('<?php echo get_post_meta($event->ID, '_EventStartDate', true); ?>'),

                    end: new Date('<?php echo get_post_meta($event->ID, '_EventEndDate', true); ?>'),

                    // Event Address
                    address: '<?php echo get_permalink($event->ID); ?>',
                  }
                });

                document.querySelector('#add_to_calendar').appendChild(myCalendar);
            </script>
