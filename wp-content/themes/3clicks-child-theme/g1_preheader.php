	...
	<div class="g1-layout-inner">
		...
		<div id="g1-preheader-bar" class="g1-meta">
			<div class="language_changer_container">
				<button id="language_changer" role="button" aria-haspopup="true"
				...
				<div class="dropdown">
					<ul id="language_dropdown" role="menu"
					    class="dropdown-menu close"
					    aria-labelledby="language_changer">
			...
			<a href="#" id="g1-preheader__switch"
			   onClick="toggle_slider('account'); return false;">
				...
				<b><?php _e( "Log in", "tcn" ); ?></b> <?php _e( "or", "tcn" ); ?>
				<b><?php _e( "Sign up", "tcn" ); ?></b>
				<?php else: ?>
				<b>S'inscrire</b>
				<?php endif ?>
				<?php endif ?>
		...
		<div id="preheader-slider-subscribe" class="preheader-slider">
			...
			<div class="g1-layout-inner subscribe-inner">
				<div id="subscribe_form_div">
					<h2>
						<span
							style="font-size: 24px; font-weight: 900;"><?php _e( "Subscribe", "tcn" ); ?> </span><span
						style="font-size: 24px;"><?php _e( "to our newsletter" ); ?></span>.

						<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
						<span style="font-size: 14px">Your email is safe with us. View our <a
							href="/privacy-policy">privacy policy.</a></span>
						<?php else: ?>
						<span style="font-size: 14px">Votre courriel est en sécurité avec nous. Affichez notre <a
					...
					<form id="newsletter_signup_form"
					      action="<?php echo site_url(); ?>/signup_login/"
					      method="POST" style="width: 500px;">
						<?php else: ?>
						<form id="newsletter_signup_form"
						      action="<?php echo site_url(); ?>/fr/signup_login_fr/"
						      method="POST" style="width: 500px;">
							<?php endif ?>
							...
							<input type="hidden" name="action"
							       value="subscribe">
							<input id="subscribe_email" type="email"
							       name="email"
							       placeholder="<?php _e( "Your email", "tcn" ); ?>"/>
							<p>
							...
							<ul class="options"
								...
								<li><label><input type="checkbox"
								                  name="english"
								                  checked="checked"/><span><?php _e( "English" ); ?></span></label>
								</li>
								<li><label><input type="checkbox"
								                  name="french"/><span><?php _e( "Français" ); ?></span></label>
								</li>
							</ul>
							<?php else: ?>
							<ul class="options"
								...
								<li><label><input type="checkbox"
								                  name="french"
								                  checked="checked"/><span><?php _e( "Français" ); ?></span></label>
								</li>
								<li><label><input type="checkbox"
								                  name="english"/><span><?php _e( "English" ); ?></span></label>
								</li>
							</ul>
							<?php endif ?>

							<input type="submit"
							       value="<?php _e( "Subscribe", "tcn" ); ?>"/>
						</form>
				</div>
				...
				<div id="subscribe_success" style="display: none">
					<div class="subscribe-success-banner">
						...
						<p style="font-size: 24px">
							Thanks for connecting with us. Why not <span
							class="orange">sign up</span>
						...
						<?php else: ?>
						<p style="font-size: 24px">
							Merci de vous être connecté avec nous. <span
							class="orange">Inscrivez-vous</span>
				...
				<div class="secondary-login-area">
					<div class="account-login">
						...
						<form id="login_form" action="/signup_login/"
							...
							<?php else: ?>
							<form id="login_form"
							      action="/fr/signup_login_fr/"
							      method="POST" style="width: 250px">
								<?php endif ?>

								<input type="hidden" name="action"
								       value="login"/>
								<h2><?php _e( "Log in", "tcn" ); ?> <span
									class="small">/ <?php _e( "current subscriber", "tcn" ); ?></span>
								</h2>
								<div id="login_errors" style="display: none"
								     class="g1-message g1-message--error">
									<div class="g1-inner"
									     id="login_errors_inner">
										&nbsp;
									</div>
								</div>
								...
								<div id="login_rows">
									<div class="row">
										<input type="text"
										       name="username_email"
										       placeholder="<?php _e( "Username or Email", "tcn" ); ?>"/>
									</div>
									<div class="row ie9-password-titles"
									     style="font-weight: 500; margin-bottom: 12px;">
										<span
											style="display: inline-block; width: 256px"><?php _e( "Password", "tcn" ); ?></span>
									</div>
									<div class="row" style="height: 42px;">
										<input type="password"
										       name="password"
										       placeholder="<?php _e( "Password", "tcn" ); ?>"/>
									</div>
									...
									<div class="row">
										<ul class="options"
											...
											<li><label><input
												type="checkbox"
												name="remember_me"
												style="margin-right: 10px;"/><span><?php _e( "Remember me", "tcn" ); ?></span></label>
											</li>
										</ul>
									</div>
									<div class="row">
							...
							<div class="forgot-hd"
								...
								<a href="#"
								   onClick="show_forgot_password_form(); return false;"><?php _e( "Forgot your username or password?", "tcn" ); ?></a>
							</div>
							<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
							<form id="forgot_email_password_form"
								...
								<form id="forgot_email_password_form"
									...
									<input type="hidden" name="lang"
									       value="<?php echo ICL_LANGUAGE_CODE; ?>"/>
									<input type="submit"
									       value="<?php _e( "Reset", "tcn" ); ?>"/>
									<div id="forgot_email_password_confirmation"
									     style="visibility: hidden">
										<?php _e( "We have sent you an email.", "tcn" ); ?>
									</div>
									<div id="forgot_email_password_errors"
									     style="display: none"
									     class="g1-message g1-message--error">
										<div class="g1-inner"
										     id="forgot_email_password_errors_inner">
											&nbsp;
										</div>
									</div>
					...
					<div class="account-signup">
						<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
						<form id="signup_form" action="/signup_login/"
						      method="POST">
							<?php else: ?>
							<form id="signup_form"
							      action="/fr/signup_login_fr/"
							      method="POST">
								<?php endif ?>
								<h2><?php _e( "Sign up", "tcn" ); ?> <span
									class="small">/ <?php _e( "new subscriber", "tcn" ); ?></span>
								</h2>
								...
								<div class="row">
									<input name="email" type="text"
									       placeholder="<?php _e( "Email", "tcn" ); ?>"/>
									<input name="username" type="text"
									       placeholder="<?php _e( "Username", "tcn" ); ?>"/>
									<input name="user_redirect"
									       class="user_redirect"
									       type="hidden" value="
										<?php
								...
								<div class="row ie9-password-titles"
									...
									<span
										style="display: inline-block; width: 256px"><?php _e( "Password", "tcn" ); ?></span>
									<span
										style="display: inline-block; width: 240px"><?php _e( "Confirm Password", "tcn" ); ?></span>
								</div>
								...
								<div class="row">
									...
									<input name="confirm_password"
									       type="password"
									       placeholder="<?php _e( "Confirm Password", "tcn" ); ?>"/>
								</div>
								<div class="row">
									<select id="tcn_user_meta_province"
									        name="tcn_user_meta_province">
										<option selected="selected"
										        value="-1"><?php _e( "Where do you live?", "tcn" ); ?></option>
										<?php for ( $i = 0; $i < get_province_count(); $i ++ ): ?>
										<option
											value="<?php echo $i; ?>"><?php echo get_province_name( $i ); ?></option>
										<?php endfor ?>
									</select>
								...
								<div class="message">
									<?php _e( "*Passwords must be at least 8 characters and contain 1 number.", "tcn" ); ?>
									<br/>
								...
								<ul class="options">
									<li><label><input type="checkbox"
									                  name="english_newsletters"
									                  checked="checked"/><span><?php _e( "English", "tcn" ); ?></span></label>
									</li>
									<li><label><input type="checkbox"
									                  name="french_newsletters"/><span><?php _e( "Français", "tcn" ); ?></span></label>
									</li>
								</ul>
								<?php else: ?>
								<ul class="options">
									<li><label><input type="checkbox"
									                  name="french_newsletters"
									                  checked="checked"/><span><?php _e( "Français", "tcn" ); ?></span></label>
									</li>
									<li><label><input type="checkbox"
									                  name="english_newsletters"/><span><?php _e( "English", "tcn" ); ?></span></label>
									</li>
								...
								<ul class="options">
									<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
									<li><label><input type="checkbox"
									                  name="terms_of_use"/><span><?php _e( "I have read the", "tcn" ); ?>
                                                        <a href="<?php echo site_url(); ?>/terms-use/"><?php _e( "Terms of Use", "tcn" ); ?></a> <?php _e( "and", "tcn" ); ?>
                                                        <a href="<?php echo site_url(); ?>/privacy-policy/"><?php _e( "Privacy Policy", "tcn" ); ?></a></span></label>
									</li>
									<?php else: ?>
									<li><label><input type="checkbox"
									                  name="terms_of_use"/><span><?php _e( "I have read the", "tcn" ); ?>
                                                        <a href="http://huddol.events.com/fr/conditions-utilisation/"><?php _e( "Terms of Use", "tcn" ); ?></a> <?php _e( "and", "tcn" ); ?>
                                                        la <a
											href="<?php echo site_url(); ?>/fr/politique-de-confidentialite/"><?php _e( "Privacy Policy", "tcn" ); ?></a></span></label>
									</li>
									<?php endif ?>
								</ul>
								<div class="g-recaptcha"
								     data-sitekey="6Ld6F0QUAAAAAGc2TeUbh-ujQyOXu7GBNWPkj9Qg"></div>
								<input type="hidden"
								       id="signup_form_secondary_is_human"
								       name="signup_form_is_human"
								       value=""/>
								<input type="hidden" name="lang"
								       value="<?php echo ICL_LANGUAGE_CODE; ?>"/>
								<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
								<input type="submit"
								       value="<?php _e( "Sign up", "tcn" ); ?>"/>
								<?php else : ?>
								<input type="submit"
								       value="<?php _e( "S'inscrire", "tcn" ); ?>"/>
								<?php endif ?>
...
<script type="text/javascript">
  ...
  function toggle_slider(slider) {
    ...
    if ($otherSlider.is(":visible")) {
      jQuery(".preheader-slider").not($slider).slideUp({
