  ...
  <div class="container" style="position: relative;width: 506px;margin: 0 auto;padding: 0px 45px;">
    ...
    <div id="content" style="position: relative;min-height: 350px;padding-top: 20px;padding-bottom: 50px;">
      ...
      <h4 style="position: relative;margin: 0px;padding: 0px;margin-bottom: 20px;margin-top: 24px;font-size: 14px;font-weight: normal;line-height: 1.75;">
        <?php _e("Vous êtes maintenant inscrit au Réseau Aidant.", "tcn" ); ?>
      </h4>
            <div style="position: relative;margin: 0px;padding: 0px;margin-bottom: 20px;margin-top: 24px;font-size: 18px; color:black;font-weight: bold;line-height: 1.75;"><?php _e("Découvrez les démarches à suivre pour vous inscrire à nos événements.", "tcn" ); ?></div>
      <div style="background-color: #ef3e29;border: 1px solid #000;color: white; width:190px; height:68px;text-align: center;text-decoration: none;border-radius: 12px;"><a href="https://www.youtube.com/watch?v=REANVHD7fPQ" style="font-family: 'Open Sans';font-size: 18px;line-height: 65px; color:white; text-decoration:none; font-weight:bold;"><?php _e("Voir la vidéo", "tcn" ); ?></a></div>
