...
{	     
    ...
    // send_email('events@huddol.com', 'Huddol Events: Surveys and Reminders Summary', $message);
    // send_email('events@huddol.com', 'Huddol Events: Surveys and Reminders Actually Sent', $sent_message);    
}
