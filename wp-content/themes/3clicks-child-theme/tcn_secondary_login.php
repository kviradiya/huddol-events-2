...
<?php if ( is_user_logged_in() ): ?>
    <div class="preheader-login">
        <ul>
            ...
            <li>
                <a href="<?php echo wp_logout_url( site_url() ); ?>"><?php _e( "Logout", "tcn" ); ?></a>
        </ul>
    </div>
<?php else: ?>
    ...
    <div class="account-login">
        ...
        <form id="login_form_secondary" action="<?php echo site_url(); ?>/signup_login/" method="POST"
            ...
            <form id="login_form_secondary" action="<?php echo site_url(); ?>/fr/signup_login_fr/"
                ...
                <p>
                    <span style="color:#ef3e29">*</span> <?php _e( "If you are already a member of our Network and are logging in to our new website for the first time, you will need to", "tcn" ); ?>
                    <a href="#"
                       onclick="reset_password_show_secondary(); return false;"><?php _e( "reset your password", "tcn" ); ?></a> <?php _e( "for security purposes.", "tcn" ); ?>
                <div id="secondary_login_errors" style="display: none"
                ...
                <div id="login_rows_secondary">
                    ...
                    <div class="row">
                        <ul class="options"
                            ...
                            <li><label><input type="checkbox" name="remember_me"
            ...
            */ ?>
			<?php if ( ICL_LANGUAGE_CODE == 'en' ): ?>
            <form id="forgot_email_password_form_secondary"
                ...
                <form id="forgot_email_password_form_secondary"
                      ...
                      method="POST" style="display: none; width:240px;">
					<?php endif ?>
                    ...
                    <div class="row">
                        <input type="text" name="username_email"
                               placeholder="<?php _e( "Provide your email", "tcn" ); ?>"/>
                    </div>

                    <input type="hidden" name="lang"
                           value="<?php echo ICL_LANGUAGE_CODE ?>"/>
                    <input type="submit" value="Reset"/>
                    <div id="forgot_email_password_confirmation_secondary"
                         style="visibility: hidden">
						<?php _e( "We have sent you an email.", "tcn" ); ?>
                    </div>
                    <div id="forgot_email_password_errors_secondary"
                         style="display: none"
                         class="g1-message g1-message--error">
                        <div class="g1-inner"
                             id="forgot_email_password_errors_inner_secondary">
                            &nbsp;
                        </div>
                    </div>
    ...
    <div class="account-signup">
        ...
        <form id="signup_form_secondary" action="<?php echo site_url(); ?>/signup_login/" method="POST">
            ...
            <form id="signup_form_secondary" action="<?php echo site_url(); ?>/fr/signup_login_fr/"
                ...
                <div id="signup_errors_secondary" style="display: none"
                     class="g1-message g1-message--error">
                ...
                <div class="row">
                    ...
                    <input name="user_redirect" class="user_redirect"
                           type="hidden" value="
					<?php
                ...
                <ul class="options">
					...
					<?php else: ?>
                        <li><label><input type="checkbox"
                                          name="terms_of_use"/><span><?php _e( "I have read the", "tcn" ); ?>
                                    <a href="<?php echo site_url(); ?>/fr/conditions-utilisation/"><?php _e( "Terms of Use", "tcn" ); ?></a> <?php _e( "and", "tcn" ); ?>
                                    la <a href="<?php echo site_url(); ?>/fr/politique-de-confidentialite/"><?php _e( "Privacy Policy", "tcn" ); ?></a>.</span></label>
                        </li>
                ...
                <input type="hidden" id="signup_form_secondary_is_human"
                       name="signup_form_is_human" value=""/>
